...
const ROWS: Row[] = [
  ...
  { label: '授業資料・メモ', sub: '録音・ノート・配布資料', href: '/materials', icon: (<svg {...ic}><path d="M4 6a2 2 0 0 1 2-2h4l2 2h6a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2z" /></svg>) },
  { label: 'シラバス', sub: '履修科目と講義概要', href: '/syllabus', icon: (<svg {...ic}><path d="M12 6.5C10.5 5 8 4.6 4.5 5v13c3.5-.4 6 0 7.5 1.5 1.5-1.5 4-1.9 7.5-1.5V5C16 4.6 13.5 5 12 6.5z" /><path d="M12 6.5V20" /></svg>) },
  { label: '学生資料室', sub: '過去問・申請様式・便覧', href: '/library', icon: (<svg {...ic}><rect x="3" y="4" width="18" height="4" rx="1" /><path d="M5 8v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8M10 12h4" /></svg>) },
  ...
  { label: 'リンク集', sub: 'CITポータル・manaba ほか', href: '/links', icon: (<svg {...ic}><path d="M9 15l6-6" /><path d="M10.5 6.5l1.7-1.7a4 4 0 0 1 5.7 5.7l-1.7 1.7" /><path d="M13.5 17.5l-1.7 1.7a4 4 0 0 1-5.7-5.7l1.7-1.7" /></svg>) },
